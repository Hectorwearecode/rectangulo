...
let comienzonombre = prompt("Introduce tu nombre");
let comienzoapellido = prompt ("Introduce tu primer apellido");
let fechacumple = prompt ("Introduce la fecha en la que naciste, por ejemplo, el 15 de enero del 70 sería 150170");
let sexopersona = prompt ("¿Cuál es tu sexo, masculino o femenino? Escríbelo:");
